...
public class MainActivity {
    ...
    private final sp.hamrahvpn.setup.MainActivity MainActivity;

    public MainActivity(Context context, ActivityMainBinding binding, sp.hamrahvpn.setup.MainActivity mainActivity) {
