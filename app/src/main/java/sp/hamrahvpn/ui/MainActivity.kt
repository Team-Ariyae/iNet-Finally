...
import sp.hamrahvpn.state.MainActivity.vpnState
import sp.hamrahvpn.util.CheckInternetConnection
import sp.hamrahvpn.util.UsageConnectionManager
...
class MainActivity : sp.vpn.module.VpnActivity("domain:ir", true), NavigationView.OnNavigationItemSelectedListener {
    ...
    private var setup: sp.hamrahvpn.setup.MainActivity? = null
    private var state: sp.hamrahvpn.state.MainActivity? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setup = sp.hamrahvpn.setup.MainActivity(this, binding, mainViewModel)
        state = sp.hamrahvpn.state.MainActivity(this, binding, setup)
